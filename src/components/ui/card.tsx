...
function CardHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "@container/card-header grid auto-rows-min grid-rows-[auto_auto] items-start gap-2 sm:gap-3 md:gap-4 px-3 sm:px-4 md:px-5 has-data-[slot=card-action]:grid-cols-[1fr_auto] [.border-b]:pb-3 sm:[.border-b]:pb-4 md:[.border-b]:pb-5",
        className
      )}
      {...props}
    />
...
function CardContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("px-3 sm:px-4 md:px-5", className)}
      {...props}
    />
  )
}
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex items-center px-3 sm:px-4 md:px-5 [.border-t]:pt-3 sm:[.border-t]:pt-4 md:[.border-t]:pt-5", className)}
      {...props}
    />
  )
}
